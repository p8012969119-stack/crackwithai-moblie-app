    ...
    <View style={styles.card}>
      ...
      <View style={styles.header}>
        <View style={styles.avatar}>
          <Image
            source={require('../assets/brand/crackwithai-logo.png')}
...
const styles = StyleSheet.create({
  ...
  avatar: {width: 42, height: 42, borderRadius: 13, backgroundColor: '#F3E8FF', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#E9D5FF', overflow: 'hidden'},
