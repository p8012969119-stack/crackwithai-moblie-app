...
export const DashboardOverview = ({
  ...
  // Pause automatic movement while the user reads or interacts.
  useEffect(() => {
    if (!active || reduceMotion) return;
    const timer = setInterval(() => {
      if (!isUserInteracting.current && Date.now() - lastInteraction.current > 5000 && scrollViewRef.current) {
        setActiveIndex((prev) => {
  ...
  return (
    <View style={styles.container} testID="dashboard-overview">
      ...
      >
        ...
        >
          <Image accessible={false} source={require('../assets/dashboard/learning.png')} style={styles.art} resizeMode="cover" />
        ...
        <Pressable accessibilityRole="button" onPress={onProfile} style={[styles.card, styles.cardTeal]}>
          <Image accessible={false} source={require('../assets/dashboard/progress.png')} style={styles.art} resizeMode="cover" />
          <View pointerEvents="none" style={styles.scrim} />
          <View style={styles.cardHeaderRow}>
            <View style={styles.iconCircleWhite}>
        ...
        <Pressable accessibilityRole="button" onPress={onProfile} style={[styles.card, styles.cardAmber]}>
          <Image accessible={false} source={require('../assets/dashboard/streak.png')} style={styles.art} resizeMode="cover" />
          <View pointerEvents="none" style={styles.scrim} />
          <View style={styles.cardHeaderRow}>
            <View style={styles.iconCircleWhite}>
        ...
        <Pressable accessibilityRole="button" onPress={onTools || onCourses} style={[styles.card, styles.cardRose]}>
          <Image accessible={false} source={require('../assets/dashboard/tools.png')} style={styles.art} resizeMode="cover" />
          <View pointerEvents="none" style={styles.scrim} />
          <View style={styles.cardHeaderRow}>
            <View style={styles.iconCircleWhite}>
...
const styles = StyleSheet.create({
  ...
  scrim: {...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(10, 8, 23, .36)'},
